...
public class CheckListRequestDto {
    ...
    public static class CheckListSaveDto {
        ...
        @NotBlank(message = "집 구조를 선택해주세요.")
        private Structure structure;

        @Schema(description = "집 / 층 (반지하, 1~3층, 4층이상)")
        @NotBlank(message = "몇층인지 선택해주세요.")
        private Floor floor;

        @Schema(description = "집 / 건물상태")
        @NotBlank(message = "건물상태를 선택해주세요.")
        private BuildingStatus buildingStatus;

        @Schema(description = "집 / 역세권(역과의 거리)")
        @NotBlank(message = "역과의 거리를 입력해주세요.")
        ...
        @NotBlank(message = "채광을 선택해주세요.")
        private Light light;

        @Schema(description = "집 / 보일러 종류 (공동난방, 개별난방)")
        @NotBlank(message = "보일러 종류를 선택해주세요.")
